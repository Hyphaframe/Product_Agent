...
def main():
    # -------------------- 页面配置 --------------------
    st.set_page_config(
        page_title="产品创新智能体系统",
        page_icon="🔍",
        layout="wide",
    )

    st.title("🔍 产品创新智能体系统")
    st.markdown("基于LangGraph的产品创新AI代理")
    ...
    with st.sidebar:
        ...
        st.markdown(
            """
            产品创新智能体系统是一个面向产品经理与创新团队的智能辅助系统，

            旨在通过人工智能技术和智能体架构，实现从市场洞察到产品创新方案的全流程智能化支持。
    ...
    query = st.text_area(
        "输入您的研究问题",
        height=100,
        placeholder="例如：我想开发一款新型智能手表，请帮我进行市场调研和产品构想。",
        help="输入您的产品构想",
    )
